        ...
        for row_index in xrange(n_rows):
            ...
            for col_index in xrange(n_cols):
                ...
                if forest_edge_distance_row[0, col_index] != forest_edge_nodata and forest_edge_distance_row[0, col_index] > 0.0 and biomass_row[0, col_index] != biomass_nodata:
                    outfile.write("%f;%f;%f;%f;%s;%s;%s" % (forest_edge_distance_row[0, col_index] * cell_size, biomass_row[0, col_index], lat_coord, lng_coord, ecoregion_lookup[ecoregion_id]['ECO_NAME'], ecoregion_lookup[ecoregion_id]['ECODE_NAME'], ecoregion_lookup[ecoregion_id]['WWF_MHTNAM']))
                    ...
                    for global_grid_resolution in [25, 50, 100, 150, 200, 300, 400, 500]:
                        ...
                        outfile.write(";%s" % (str(int(global_grid_row/(global_grid_resolution*1000))) + '-' + str(int(global_grid_col/(global_grid_resolution*1000)))))
                    outfile.write('\n')
